...
(function() {
  var Aonyx, PARAM_REGEX, _, _argumentsFor, _emptyServices, _formatName, _getParamList, _getService, _injectServices, _mergeArguments, _registerService, _removeService, _serviceExists, _serviceFor, _services, _setPrototype,
    __slice = [].slice;
