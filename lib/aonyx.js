...
(function() {
  var Aonyx, PARAM_REGEX, _, _argumentsFor, _emptyServices, _formatName, _getParamList, _getService, _injectServices, _mergeArguments, _registerService, _removeService, _serviceExists, _serviceFor, _services,
    __slice = [].slice;
  ...
  _getParamList = function(method) {
    ...
    return params = match[2].split(/\s*,\s*/);
  };
